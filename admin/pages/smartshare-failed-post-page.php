				...
				<div class="ss-share">
					...
					<div class="ss-share-details">
						<div class="ss_tab_info">
							<p><?php esc_html_e( 'You will see the list of “failed” posts, which is failed during the sharing time due to some technical issue.', 'social-media-smart-share' ); ?></p>
						</div>
						<?php
						if ( $failed_post_list_count > 0 ) {
							include plugin_dir_path( dirname( dirname( __FILE__ ) ) ) . 'admin/pages/smartshare-inner-listings.php';
						} else {
							printf( '<div class="ss-share-row">%s</div>', esc_html_e( 'No post found.','social-media-smart-share' ) );
						}
						?>
